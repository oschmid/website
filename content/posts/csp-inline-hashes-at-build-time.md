...
---
This website has a `Content-Security-Policy` header that tells browsers to block inlined scripts and styles except for 
those matching trusted sha256 hashes. Rather than manually updating this header every time any of these scripts or 
styles changes, I created [csp-inline-hashes](https://github.com/oschmid/website/blob/master/bin/csp_inline_hashes.go). 
...
generate sha256 hashes for each inlined script and style, and use the template at `layouts/_headers` to write out a 
